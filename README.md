...
2. Create a `.env` file and add your [Together AI API key](https://togetherai.link/?utm_source=napkins&utm_medium=referral&utm_campaign=example-app): `TOGETHER_API_KEY=`
